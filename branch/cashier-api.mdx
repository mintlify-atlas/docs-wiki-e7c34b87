...
Cashier lookup and CRUD are introduced in [Teller API](teller-api); this page focuses on the three write flows and the flat lookup.
...
- [Domain model](teller-and-cashier-domain) — `Cashier`, `CashierTransaction`, `CashierTxnType` reference.
- [Teller API](teller-api) — surrounding teller CRUD.
