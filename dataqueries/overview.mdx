...
- [Datatables](/dataqueries/datatables) — registration, schema mutation, row CRUD, `ReadWriteNonCoreDataService` / `DatatableWriteServiceImpl`.
...
See the full REST reference at [Reports and data APIs](/api/reports-and-data-apis).
...
- The hooks system that fires business events on datatable writes: [Hooks overview](/hooks/overview), [Hooks and messaging APIs](/api/hooks-and-messaging-apis).
