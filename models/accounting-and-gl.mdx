...
| `m_journal_entry_aggregation_summary`    | `infrastructure.jobs.service.aggregationjob.domain.JournalEntrySummary` | created in `0001_initial_schema.xml` / extended by `0021_external_owner_reference_in_journal_entry_aggregation.xml` (adds FK to `m_external_asset_owner`) |
| `m_journal_entry_aggregation_tracking`   | `infrastructure.jobs.service.aggregationjob.domain.JournalEntryAggregationTracking` | created in `0001_initial_schema.xml`                                              |
