...
| `NoProvisioningCriteriaDefinitionFoundException` | Loan product has no criteria attached. |
...
| --- | --- | --- | --- | --- | --- | --- |
| A | USD | DEBIT | Provision Expense - Doubtful | 12,500.00 | PROVISIONING(3) | provisioningEntryId |
| A | USD | CREDIT | Provision Liability - Doubtful | 12,500.00 | PROVISIONING(3) | provisioningEntryId |
