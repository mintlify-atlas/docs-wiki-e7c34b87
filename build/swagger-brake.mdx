...
The baseline `fineract-provider/config/swagger/fineract-baseline.json` lives in version control. It represents the **frozen contract for the current release line**. Updating it is a deliberate release-management step:
