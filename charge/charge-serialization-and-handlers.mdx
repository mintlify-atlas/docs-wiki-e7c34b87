...
- For the broader picture of how the `m_command_source` log, makers/checkers and permissions integrate with the handler dispatch, see [Configuration and code APIs](/api/global-configuration).
