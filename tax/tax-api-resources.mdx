...
- For the broader API surface, including how `taxGroupId` shows up on `Charge`, `LoanProduct` and `SavingsProduct` JSON: [Configuration and code APIs](/api/configuration-and-code-apis).
