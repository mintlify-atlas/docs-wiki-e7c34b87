...
This page documents the interface, the abstract base, the nine shipped cumulative strategies (in `fineract-loan`), and the progressive `AdvancedPaymentScheduleTransactionProcessor` (in `fineract-progressive-loan`).
