...
- The matching REST endpoints for running reports interactively → [Reports and data APIs](/api/reports-and-data-apis).
...
- For the interactive `runreports` endpoint, datatable APIs, and the `m_report` / `m_report_parameter` schema: [Reports and data APIs](/api/reports-and-data-apis).
