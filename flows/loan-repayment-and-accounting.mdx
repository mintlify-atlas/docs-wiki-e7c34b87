...
See [Loan Accruals Processing](/cob/business-step-categories#periodic-accrual-posting) and [Accounting Closure & Accruals](/accounting/accrual-postings).
...
<CardGroup cols={2}>
  ...
  <Card title="Cash vs Accrual Accounting" href="/accounting/accounting-processors">Mappings for `CashAccountsForLoan` and `AccrualAccountsForLoan`.</Card>
